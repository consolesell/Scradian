...
function generateSampleData() {
    const sampleData = [
        ...
        },
        {
            ...
            price: 8000,
            images: [
                "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=M3wxMjA3f BLAH DB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2058&q=80"
            ],
            rating: 3.9,
    ...
    if (propertiesToShow.length === 0) {
        propertiesGrid.innerHTML = `
            <div class="col-span-full text-center py-20">
                ...
                <p class="text-gray-500 mb-6">Try triggering your search criteria</p>
